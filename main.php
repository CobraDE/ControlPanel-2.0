      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo $o_main->getImpressum();?>"><i class="fa fa-circle-o text-red"></i> <span>Impressum</span></a></li>
			<li class="treeview">
              <a href="#">
			...
			<?php 
				if($o_main->isProjektleitung($_SESSION["acc"])){
					echo "
						...
						<li><a href='main.php?site=admin'><i class='fa fa-circle-o text-red'></i> <span>Allgemein</span></a></li>
						<li><a href='main.php?site=admint'><i class='fa fa-circle-o text-red'></i> <span>Tickets</span></a></li>
					";
				}
			?>
          </ul>
